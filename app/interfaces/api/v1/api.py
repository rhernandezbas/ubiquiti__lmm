...
from app.interfaces.api.v1.endpoints import diagnostics, devices, ap_optimization, device_analysis_complete, logs, device_overview, ap_clients, debug_ssh, remote_ap_clients
...
api_router.include_router(remote_ap_clients.router, tags=["Remote AP Clients"])
