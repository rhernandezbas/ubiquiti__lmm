...
async def generate_llm_analysis(
    ...
    - Si hay mejor AP: menciona si vale la pena cambiar teniendo en cuenta los clientes del actual y del mejor AP y a su vez los dmb de diferencia, mientras menos clientes es mejor , si la señal no varia de 3 dbm
