...
class CreatePostMortemRequest(BaseModel):
    ...
    incident_start: Optional[str] = Field(None, description="Incident start time")
    incident_end: Optional[str] = Field(None, description="Incident end time")
    detection_time: Optional[str] = Field(None, description="Detection time")
    response_time: Optional[str] = Field(None, description="Response time")
    resolution_time: Optional[str] = Field(None, description="Resolution time")
    downtime_minutes: Optional[int] = Field(None, description="Downtime in minutes")
